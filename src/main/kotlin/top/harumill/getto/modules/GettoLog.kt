...
class GettoLogger(
    ...
    fun logEvent(event:Event){
        ...
        val noLogEvent = arrayListOf(
            "ConfigPush","FriendMessagePreSendEvent","FriendInputStatusChangedEvent","GetMsgSuccess","GroupMessagePreSendEvent",
            "MemberCardChangeEvent","SendGroupMessageReceipt","BeforeImageUploadEvent","Succeed","ServerListPush","EmptyResponse"
        )
        when(eventName){
            in noLogEvent -> {
//                ouputLog(eventName)
